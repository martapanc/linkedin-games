        ...
        return (
          ...
          >
            {(mark === 1 || auto) && (
              <svg
                viewBox="0 0 24 24"
                className="h-[36%] w-[36%] text-black/55"
                aria-hidden="true"
              >
                <path
            ...
            {hintEvidence.has(i) && !hintTargets.has(i) && (
              <span className="pointer-events-none absolute inset-0 bg-sky-500/25 ring-2 ring-inset ring-sky-600/70" />
            )}
            {hintTargets.has(i) && (
              <span className="pointer-events-none absolute inset-0 animate-pulse ring-4 ring-inset ring-sky-600" />
            )}
          </button>
        );
      })}
