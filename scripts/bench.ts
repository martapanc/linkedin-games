 ...
 */
import {DEFAULT_SIZE, generatePuzzle} from "../lib/queens/generator";
import {analyze, findSolutions, TIER_NAMES} from "../lib/queens/solver";
import {DIFFICULTIES} from "../lib/queens/types";

const ROUNDS = 20;

// Each difficulty at the size the app actually ships it at — those are the
// timings that decide whether a phone sits on "generating".
